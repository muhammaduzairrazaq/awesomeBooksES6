...
This is a solo project similar to the Awesome Books app I previously created. The only difference is that this time, I developed a book app using ES6 modules with the 'export' and 'import' keywords.
...
```sh
  cd my-folder
  git clone: (git@github.com:muhammaduzairrazaq/awesomeBooksES6.git)
```
